...
* **Reproducibilidad:** The CGC ensures reproducibility by recording all aspects of analysis, including files used, tool versions, and parameter settings using **Common Workflow Language (CWL)**.
...
[cite_start]The following figures illustrate how the CGC integrates data, computation, and visualization to support collaborative research[cite: 39, 217].

![Seven Bridges CGC Figure 1]({{ '/images/HOL1.png' | relative_url }})
{: .mx-auto.d-block :}

[cite_start]**Figure 1: The Cancer Genomics Cloud Ecosystem.** * **A:** The system enables users to upload private data, annotate it with metadata, and run analyses using optimized resources[cite: 218, 219].
* [cite_start]**B:** Time course showing over 9,000 RNA-Seq samples analyzed in parallel, all completed within 100 minutes[cite: 41, 221].
* [cite_start]**C:** The **Data Browser** allows users to explore and select data by specifying properties of interest visually[cite: 49, 221].
* [cite_start]**D:** The **Case Explorer** focuses on genetic properties, allowing global views of gene expression and mutation status[cite: 61, 223].
